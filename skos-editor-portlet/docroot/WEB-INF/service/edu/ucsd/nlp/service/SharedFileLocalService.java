...
/**
 * Provides the local service interface for SharedFile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author http://nlp-app.ucsd.edu
 * @see SharedFileLocalServiceUtil
...
public interface SharedFileLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SharedFileLocalServiceUtil} to access the shared file local service. Add custom service methods to {@link edu.ucsd.nlp.service.impl.SharedFileLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
