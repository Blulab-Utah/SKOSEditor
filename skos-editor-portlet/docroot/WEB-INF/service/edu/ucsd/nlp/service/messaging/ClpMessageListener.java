...
package edu.ucsd.nlp.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ObjectHistoryLocalServiceUtil.clearService();

			SharedFileLocalServiceUtil.clearService();

			SKOSCollaborationEntryLocalServiceUtil.clearService();

			SKOSFileLocalServiceUtil.clearService();

			SKOSSettingLocalServiceUtil.clearService();
		}
	}
}