 ...
 * @generated
 */
public class SKOSCollaborationEntryLocalServiceClp
	implements SKOSCollaborationEntryLocalService {
	public SKOSCollaborationEntryLocalServiceClp(
		...
		_methodName20 = "removeByFileUser";

		_methodParameterTypes20 = new String[] { "long", "long" };

		_methodName21 = "findByFileUser";
	...
	public edu.ucsd.nlp.model.SKOSCollaborationEntry addSKOSCollaborationEntry(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(skosCollaborationEntry)
					});
		}
		catch (Throwable t) {
		...
		return (edu.ucsd.nlp.model.SKOSCollaborationEntry)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<edu.ucsd.nlp.model.SKOSCollaborationEntry> getSKOSCollaborationEntries(
		...
		return (java.util.List<edu.ucsd.nlp.model.SKOSCollaborationEntry>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public edu.ucsd.nlp.model.SKOSCollaborationEntry create(long skosFileId,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					ClpSerializer.translateInput(updateType),
					...
					ClpSerializer.translateInput(type2),
	...
	public void removeByFileUser(long skosFileId, long userId) {
		try {
			_invokableLocalService.invokeMethod(_methodName20,
				_methodParameterTypes20, new Object[] { skosFileId, userId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<edu.ucsd.nlp.model.SKOSCollaborationEntry> findByFileUser(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					_methodParameterTypes21, new Object[] { skosFileId, userId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
