...
/**
 * Provides the local service interface for SKOSSetting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author http://nlp-app.ucsd.edu
 * @see SKOSSettingLocalServiceUtil
...
public interface SKOSSettingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SKOSSettingLocalServiceUtil} to access the s k o s setting local service. Add custom service methods to {@link edu.ucsd.nlp.service.impl.SKOSSettingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
