...
import edu.ucsd.nlp.service.ObjectHistoryLocalService;
...
/**
 * Provides the base implementation for the object history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.ucsd.nlp.service.impl.ObjectHistoryLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ObjectHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ObjectHistoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edu.ucsd.nlp.service.ObjectHistoryLocalServiceUtil} to access the object history local service.
	 */
	...
	@Override
	public ObjectHistory addObjectHistory(ObjectHistory objectHistory)
		throws SystemException {
		objectHistory.setNew(true);

		return objectHistoryPersistence.update(objectHistory);
	}
	 ...
	 */
	@Override
	public ObjectHistory createObjectHistory(long id) {
		return objectHistoryPersistence.create(id);
	}
	...
	@Override
	public ObjectHistory deleteObjectHistory(long id)
		throws PortalException, SystemException {
		return objectHistoryPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ObjectHistory deleteObjectHistory(ObjectHistory objectHistory)
		throws SystemException {
		return objectHistoryPersistence.remove(objectHistory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ObjectHistory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return objectHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return objectHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ObjectHistory fetchObjectHistory(long id) throws SystemException {
		return objectHistoryPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ObjectHistory getObjectHistory(long id)
		throws PortalException, SystemException {
		return objectHistoryPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return objectHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ObjectHistory> getObjectHistories(int start, int end)
		throws SystemException {
		return objectHistoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getObjectHistoriesCount() throws SystemException {
		return objectHistoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ObjectHistory updateObjectHistory(ObjectHistory objectHistory)
		throws SystemException {
		return objectHistoryPersistence.update(objectHistory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("edu.ucsd.nlp.model.ObjectHistory",
			objectHistoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = objectHistoryPersistence.getDataSource();
	...
	private ObjectHistoryLocalServiceClpInvoker _clpInvoker = new ObjectHistoryLocalServiceClpInvoker();
}