...
import edu.ucsd.nlp.service.SharedFileLocalService;
...
/**
 * Provides the base implementation for the shared file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.ucsd.nlp.service.impl.SharedFileLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SharedFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SharedFileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edu.ucsd.nlp.service.SharedFileLocalServiceUtil} to access the shared file local service.
	 */
	...
	public SharedFile addSharedFile(SharedFile sharedFile)
		...
		return sharedFilePersistence.update(sharedFile);
	}
	 ...
	 */
	@Override
	public SharedFile createSharedFile(long id) {
		return sharedFilePersistence.create(id);
	}
	...
	@Override
	public SharedFile deleteSharedFile(long id)
		throws PortalException, SystemException {
		return sharedFilePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SharedFile deleteSharedFile(SharedFile sharedFile)
		throws SystemException {
		return sharedFilePersistence.remove(sharedFile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SharedFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return sharedFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return sharedFilePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return sharedFilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SharedFile fetchSharedFile(long id) throws SystemException {
		return sharedFilePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public SharedFile getSharedFile(long id)
		throws PortalException, SystemException {
		return sharedFilePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return sharedFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SharedFile> getSharedFiles(int start, int end)
		throws SystemException {
		return sharedFilePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSharedFilesCount() throws SystemException {
		return sharedFilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SharedFile updateSharedFile(SharedFile sharedFile)
		throws SystemException {
		return sharedFilePersistence.update(sharedFile);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("edu.ucsd.nlp.model.SharedFile",
			sharedFileLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"edu.ucsd.nlp.model.SharedFile");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = sharedFilePersistence.getDataSource();
	...
	private SharedFileLocalServiceClpInvoker _clpInvoker = new SharedFileLocalServiceClpInvoker();
}