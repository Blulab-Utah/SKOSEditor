...
import edu.ucsd.nlp.service.SKOSSettingLocalService;
...
/**
 * Provides the base implementation for the s k o s setting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.ucsd.nlp.service.impl.SKOSSettingLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SKOSSettingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SKOSSettingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edu.ucsd.nlp.service.SKOSSettingLocalServiceUtil} to access the s k o s setting local service.
	 */
	...
	@Override
	public SKOSSetting addSKOSSetting(SKOSSetting skosSetting)
		throws SystemException {
		skosSetting.setNew(true);

		return skosSettingPersistence.update(skosSetting);
	}
	 ...
	 */
	@Override
	public SKOSSetting createSKOSSetting(long skosSettingId) {
		return skosSettingPersistence.create(skosSettingId);
	}
	...
	@Override
	public SKOSSetting deleteSKOSSetting(long skosSettingId)
		throws PortalException, SystemException {
		return skosSettingPersistence.remove(skosSettingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SKOSSetting deleteSKOSSetting(SKOSSetting skosSetting)
		throws SystemException {
		return skosSettingPersistence.remove(skosSetting);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SKOSSetting.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return skosSettingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return skosSettingPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return skosSettingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SKOSSetting fetchSKOSSetting(long skosSettingId)
		throws SystemException {
		return skosSettingPersistence.fetchByPrimaryKey(skosSettingId);
	}
	 ...
	 */
	@Override
	public SKOSSetting getSKOSSetting(long skosSettingId)
		throws PortalException, SystemException {
		return skosSettingPersistence.findByPrimaryKey(skosSettingId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return skosSettingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SKOSSetting> getSKOSSettings(int start, int end)
		throws SystemException {
		return skosSettingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSKOSSettingsCount() throws SystemException {
		return skosSettingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SKOSSetting updateSKOSSetting(SKOSSetting skosSetting)
		throws SystemException {
		return skosSettingPersistence.update(skosSetting);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("edu.ucsd.nlp.model.SKOSSetting",
			skosSettingLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"edu.ucsd.nlp.model.SKOSSetting");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = skosSettingPersistence.getDataSource();
	...
	private SKOSSettingLocalServiceClpInvoker _clpInvoker = new SKOSSettingLocalServiceClpInvoker();
}